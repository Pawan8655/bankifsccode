  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        image: 'https://logo.clearbit.com/kotak.com',
    ...
    products: [
      {
        ...
        provider: 'Zerodha',
        image: 'https://logo.clearbit.com/zerodha.com',
      ...
      },
      {
        ...
        provider: 'Upstox',
        image: 'https://logo.clearbit.com/upstox.com',
  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        provider: 'Niva Bupa',
        image: 'https://logo.clearbit.com/nivabupa.com',
                        ...
                        <Card key={product.name} className="min-w-[280px] rounded-2xl border-slate-200 shadow-sm">
                          <CardContent className="p-4">
                            <img
                              ...
                              className="mb-3 h-12 w-12 rounded-md border border-slate-200 bg-white p-1 object-contain"
                              loading="lazy"
                            />
